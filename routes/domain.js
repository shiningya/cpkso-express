...
function getCompany(domain) {
    var url = 'http://localhost:8080/ev/company_singleDomainName?company.domain_name=' + domain;
    return axios.get(url);
}
  
function getComProds(domain) {
    var url = 'http://localhost:8080/ev/product_findByCompany?company.domain_name=' + domain;
    return axios.get(url);
}
